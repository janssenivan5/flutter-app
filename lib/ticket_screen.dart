...
class TicketScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFF064E3B), // Latar belakang hijau emerald penuh untuk kesan eksklusif
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              // Kembali ke layar paling awal (Home Screen)
      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // Indikator Sukses
              const Icon(Icons.check_circle, color: Color(0xFFD4AF37), size: 80), // Warna emas
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    // Widget QR Code Placeholder bawaan Flutter
